...
class ApolloScapeSegmentation(Dataset):
    ...
    def __init__(self, args, root_dir=Path.db_root_dir('apolloscape'), split='train'):
...
# __name__ == __main__ append desired different modules into dataset to deploy them in this dataset
